...
开始->运行：msinfo32，在系统摘要页面，查看“关闭”的那些安全相关选项，逐个开启。
...
设置->更新和安全->windows安全中心，左侧页面点击“打开Windows安全中心”
    ...
    目前发现windows 10 21H1版本的“核心隔离”类别中缺少“内核DMA 保护”、“固件保护”等，而windows 2019 LTSC版本是有的，
...
另一个是windows沙盒应用，也是类似的情况。这两个待研究。
...
运行危险程序
    ...
    开始菜单，选择“windows sandbox”程序，将新开一个windows窗口，把你觉得危险的程序复制粘贴到这个系统里运行，格式化这里的硬盘都没关系，在这个系统里还可以正常上网。
    这个系统一旦关闭，里面的任何操作都会清零，所以可以把运行结果复制粘贴到正常使用的windows中。

关于windows沙盒运行，参见 <https://docs.microsoft.com/zh-cn/windows/security/threat-protection/windows-sandbox/windows-sandbox-overview>
