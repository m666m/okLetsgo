...
如果是英文 Windows，设置了区域是新加坡等非中国区域，在安装传统的（gbk 编码）简体中文 Windows 程序时出现乱码提示，无法进入程序
...
如果是英文 Windows，Edge 浏览器的英文网页默认不出现“翻译”选项

    在 “设置” 里选择 “语言”，添加中文，并点击按钮“...”（更多操作）勾选 “让我选择使用此语言翻译页面”，并选择上移到顶部，以便优先级高于默认的英文。
