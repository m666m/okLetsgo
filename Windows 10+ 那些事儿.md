...
4K 分辨率流行后设计原则变了，渲染用 1K 材质然后放大到 4K 的优化技术、DLSS 等等歪招全来了。如果感觉你的游戏中画质有点糊，不够清晰锐利，即使在游戏设置中把贴图细节拉到最高也没有效果。

这种情况下，在游戏设置里找显示画面的设置页，把锐化相关选项拉高再看看，如果启用了 DLSS，可能还有 DLSS 的锐化选项。另外，DLSS 的档位尽量选择质量或 DLAA，比性能档更清晰。

    Doom:The Dark Ages 锐化拉到 2~3 清晰感就跟之前的 Doom：Eternal 差不多了。这代游戏为了优化，把大多数的材质限制在粗糙度阈值之下，总给人画面比较糊的感觉。
...
光线追踪的某些游戏非常显著，对光线直射和背光混杂的视角变化处理不好，亮处很亮而暗部画面很黑，除非转头只看暗处才能看清，在支持 HDR 效果的游戏上更明显。这个问题的根源在于游戏的调校。调校不好的例子是2077的白天出入建筑,调校的好的例子是 Doom:The dark ages，明暗过渡更自然，高光给人冲击暗部也有足够的亮度，细节丰富，没有 2077 那种门口的箱子死黑看不清只能趴下看，大白天想打手电筒的情况。这也就是为什么 2077 玩家都喜欢秀夜景呢，因为夜景不介意暗处黑了，站个大灯低下看彩灯实在太酷炫。

1、如果是游戏暗处太黑（含光线追踪），首先在游戏内设置调整 伽马值，适当放大，达到暗处稍亮而亮处不发白即可。

如果是 HDR 显示器，游戏内一般会有个专门的 HDR 效果设置页面，可以调整亮度、色调等细节。

光线追踪的游戏，对比度亮度都是动态的，全局光照的曝光度也随着视角和环境变化，单纯调节显示器的亮度没什么用。

2、游戏内设置，如果支持就把光线追踪的路径追踪选项打开。这样有粗糙度的表面会弱弱的反射光线，粗糙材质增加了反射细节会使物体稍微变亮。另外，火焰、灯光等自发光材质也能稍微照亮周边，都能增加一点场景的暗部亮度。

比如 Doom:Then Dark Ages 为了优化，把大多数的材质限制在粗糙度阈值之下，场景中的动态光影和阴影特效也用的非常克制，场景内反光的材质不多，虽然没有全黑场景但是在暗处感觉乌图图的，开启路径追踪能稍微增加整体的亮度感觉。
