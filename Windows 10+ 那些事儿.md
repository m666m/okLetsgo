...
光线追踪的某些游戏，对光线直射和背光混杂的视角变化处理不好，亮处很亮而暗部画面很黑，除非转头只看暗处才能看清，在开启 HDR 时更明显，这个不是什么黑屋出门看强光的人眼效果，这个是光照曲线有问题。问题的根源在于游戏的设计和调校。不好的例子是2077的白天场景的动态死黑，好的例子是 Doom:The dark ages，光线追踪全局光照（RTGI）调校的好明暗过渡自然，高光给人冲击时暗部也有足够的亮度细节能看清，没有 2077 那种门外有光门里的箱子却黢黑看不清只能趴下看，白天在街上转头却想打手电筒的情况。这也是为什么 2077 玩家都喜欢秀夜景的原因，因为夜景不介意暗处黑，站个大灯底下看彩灯实在太酷炫。像 2077 这样粗暴的光污染却契合了赛博朋克风格，属于取巧了。
...
2、游戏内设置，如果支持就把光线追踪的“路径追踪”选项打开。这样有粗糙度的材质会增加反射细节使物体稍微变亮。另外，火焰、灯光等自发光材质也能稍微照亮周边，这些都可以增加一点场景中物体的暗部亮度。

比如 Doom:Then Dark Ages 为了优化，把大多数的材质限制在粗糙度阈值之下，场景中的动态光影和阴影特效也用的非常克制，场景内远景就能反光的物体很少，暗处乌图图的细节但是可以看清，开启“路径追踪”能稍微增加整体的亮度感觉。
