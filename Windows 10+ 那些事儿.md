...
在开放场景中常见背光面死黑、白天屋里很黑这种高光强对比度让人眼睛不舒服的情况，根源在于光线追踪迫于计算量优化不能放置太多光线，这就非常依赖美工对材质风格的统一处理和具体场景设计时的光影调校，大多数厂商不是实力不足就是不想花太多时间进行调校。为了方便（削减成本），很多游戏都使用自动曝光技术，根据视野焦点把暗部慢慢给你调亮，导致被光线直射的物体背光的暗部出现死黑，只看暗部又会受环境光照影响慢慢变亮，让你的眼睛非常不舒服。这不是什么黑屋看门口强光的 HDR 过曝效果，这就是游戏对直射光和非直射光混杂的视角变化处理的不好，完全属于游戏的设计和调校问题：

    黑神话·悟空，第二章的山洞场景不是过曝亮瞎眼就是黑乎乎什么都看不到，沙漠场景中明暗同时存在的视角闪爆你的眼球，对比度拉的极高但是全局光照考虑的太少，大白天的阴影里愣是黑得伸手不见五指。

    塞伯朋克2077 也是类似的问题，白天的时候物体的背光面死黑，屋里也死黑。在阳光直射的大街上转动视角就有想打手电筒的感觉，原地蹲下屏幕四边都发黑就像犯了低血糖。不要说原本就是黑的，你只看暗部的时候它会慢慢变亮给你正确的计算结果。为什么 2077 玩家都喜欢秀夜景？因为夜景不介意暗处黑，站在大灯底下看彩灯实在太酷炫。像 2077 这样粗暴的光污染却契合了赛博朋克风格，属于取巧了。
...
游戏内的设置，开启 “路径追踪”，可以增加漫反射效果，提升画面整体的亮度和明暗表现，而且真实感更强。开启了光线的二次反弹后，非镜面的反光物(有粗糙度的材质)也会投射光线到其他物体，使周围环境稍微变亮或增加阴影。灯条等自发光材质也能稍微照亮周边物体。
