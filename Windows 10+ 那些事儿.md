...
最终，我们得到了充满了各种妥协的光线追踪游戏画面：
    ...
    Nvidia DLSS 用 AI 生成画面来减少计算量。从低分辨率生成高分辨率画面，到直接插帧生成新画面，各种歪招全都有。

总体来说，现在的光线追踪游戏，有点类似数码相机刚出来的时代，清晰度是不如传统相机的，但是多次迭代后清晰度达标了，几年功夫就实现了对传统相机的替代。Nvidia 在显卡计算能力不足时强推光线追踪，在 2025年 实现的游戏画面导致玩家无法理解：

    跟之前的光栅游戏相比，光线追踪技术的画面真实感轻微提升，清晰度明显下降（很多玩家贴2015年游戏的截图），反射效果明显提升，物体暗部死黑太多（预烘焙减少），帧率爆降，从使用 UE5 引擎开发的各种游戏，到 Doom:The Dark Ages 全都如此。

    比如 Doom:The Dark Ages，抛弃了光栅化渲染而完全使用光线追踪，为了减少反射的计算量，场景中绝大部分物体的材质都限制在粗糙度阈值之下贴近看都是糊，镜面效果只见于水面和地面的水洼，很少放置玻璃和镜子，反射远景的物体很少，动态光源的使用也非常克制。各种降低视觉效果，换来的居然只是画面整体的光影真实感更强一些，功耗近 400 瓦的 RTX5080 显卡开路径追踪后都跑不到 60 帧/秒。
