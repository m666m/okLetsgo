...
光线不足的话，比如预烘培和游戏中的光影计算都尽量简化，人物渲染效果就会表现出卡通化，比如手机游戏、3D 网游等对显卡要求很低的游戏，即使画面非常清晰，但画面风格只能做卡通化的。
...
数字电子技术中涉及光线的运算，一直存在“散粒噪声”的问题。在相机上，可以用更大的光圈和更好的CMOS来缓解。但是在电子游戏里，只能发射更多光线或者用算法降噪。

    发射的光线越多则画面效果越好，但需要庞大的算力，5090 显卡在这面前也只能说是“小小的也很可爱”。
