...
光线追踪的某些游戏，对光线直射和背光混杂的视角变化处理不好，亮处很亮而暗部画面很黑，转头只看暗处又会变亮，在开启 HDR 时更明显，这个不是什么黑屋出门看强光的人眼效果，这个是光照曲线有问题，根源在于游戏的设计和调校。
    ...
    不好的例子是 赛博朋克2077 的白天场景各种物体的暗部动态死黑，在阳光部分直射的大街上转头就有想打手电筒的感觉。 这也是为什么 2077 玩家都喜欢秀夜景的原因，因为夜景不介意暗处黑，站个大灯底下看彩灯实在太酷炫。像 2077 这样粗暴的光污染却契合了赛博朋克风格，属于取巧了。

    好的例子是 Doom:The dark ages，光线追踪全局光照（RTGI）调校的好，高光给人冲击时暗部也有足够的亮度能看清细节，明暗过渡自然转换视角时眼睛完全不累。另外没光的山洞里也会细心的放置光源，死黑很少见，不需要打手电。
...
调显示器亮度对比度的方式不适合现代游戏
    ...
    而且，如果开启 HDR 显示器会自动切换到最高亮度，全靠游戏或视频每帧画面的hdr亮度数据来动态变化明暗。
