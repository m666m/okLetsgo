...
所以电竞选手一般选择高回报率鼠标和支持可变刷新率如 Nvidia G-sync 标准的高刷显示器，搭配高配显卡保证帧率跟的上刷新旅。
...
我玩射击游戏，关垂直同步才不头晕
    ...
    建议除非遇到画面撕裂或抖动的问题，再开垂直同步，也可选择开启三重缓冲缓解头晕，但是偶尔会卡一下。酌情处理吧，一般来说开三重缓冲后，快速晃动鼠标时画面即时跟随你的动作没有迟滞感就可以。

头晕的原因可能在于相对于手的快速动作跟大脑一致，而屏幕的显示相对帧率波动性延迟，而 fps 射击游戏频繁快速的转身和视角变换，导致大脑对手运动的感知和对视觉的感知不一致，进而导致头晕。

另外把环境晃动、摄像头晃动都关了，这种老式游戏战斗时镜头快速变化让你视觉模糊甚至头晕恶心来制造压迫感，随后的胜利就能给你释放的快感。但是晃画面是让人必晕的，没啥意思，关了反而游戏体验更好。
