...
我玩射击游戏，关垂直同步才不头晕
    ...
    解决晕 3D 最好关闭垂直同步，这个技术锁帧为你的屏幕刷新率数值会导致画面延迟，开启三重缓冲能缓解头晕，但是偶尔会卡一下。头晕的原因可能在于相对于手的动作，屏幕的显示有延迟且随帧率波动，fps 射击游戏频繁快速的转身和视角变换导致大脑对手运动的感知和对视觉的感知不一致，进而导致头晕

    另外把环境晃动、摄像头晃动都关了，这种老式游戏靠视觉看不清头晕恶心来制造各种压抑感最终给你释放的快感
...
比如 Doom:The Dark Ages 为了优化，把大多数的材质限制在粗糙度阈值之下，总给人画面比较糊的感觉，而把“锐化”拉到 3~4 后，清晰感就跟之前的 Doom：Eternal 差不多了，跟过场动画的细节类似。
