...
运行危险程序
    ...
    windows沙盒对应的是MsMpEngCP.exe和MsMpEng.exe进程。
...
<Configuration>
  <MappedFolders>
    <MappedFolder>
      <HostFolder>C:\StartHere\tools\cpu-z</HostFolder>
...
关于windows沙盒的详细介绍，参见 <https://docs.microsoft.com/zh-cn/windows/security/threat-protection/windows-sandbox/windows-sandbox-overview>
