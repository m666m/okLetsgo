...
光影对人类视觉的影响，拿素描进行理解，在纸上几条线段是二维图像，在背景浓淡相宜的扫几笔，有了光影感就出来立体感了，要再逼真就得加色彩，再逼真就得加大细节上色彩和光影的变化。
...
光线追踪流行后设计原则变了，如果你在游戏选项中把画质细节拉满了还是觉得画面“糊”，大致原因就是游戏引擎切换为未来的方向 --- 光线追踪：
    ...
    想要进一步的增加真实感，不得不切换到使用光线追踪技术，其在反射、折射上最明显。光线追踪技术在光影方面对每个像素点进行实时计算：屏幕上的每个像素点都投射n多个光线，打到各个物体上，反射后如果达到光源如灯、太阳，则屏幕上的这个像素点就发什么颜色的光。其计算混合了物体的材质，光源的强弱等多种因素，实际显示效果就比传统的光栅化处理更加真实。
