...
光线追踪和路径追踪：
    ...
    N 卡 4080 时代宣传的路径追踪，逐渐的在抛弃光栅化渲染，更多的使用光追的路径追踪算法来形成画面，极大的增加了对显卡硬件的消耗。比如 Doom:The Dark Ages 完全使用光线追踪渲染画面，跟上一代的 Doom:Eternal 比只是光影感觉更真实，画质细节完全没有进步，远看不错贴近就是糊。
