...
Download Chat model 聊天（Chat） 与 编辑（Edit）
    ...
    ollama pull llama3.1:8b  # 中文支持更好 qwen2.5-coder:7b
...
Download Embeddings model 代码库感知（Codebase Awareness）
    ...
    ollama pull nomic-embed-text:latest  # 中文支持更好 shaw/dmeta-embedding-zh
...
2、saoudrizwan.claude-dev (原 Claude Dev)
