...
某些游戏把光线追踪、反锯齿等高画质功能拉满后，特别是在 4K 分辨率的显示器下，显存占用超过 8GB，会提示显存不足，严重情况下一卡一卡的。

如果没爆显存是游戏优化的好，画质稍微降低或切换到内存，你感觉不出来。

解决办法，如果想凑合下，开启 DLSS，可以稍微降低对显存的需求，或者在游戏选项中适当降低画质。
...
注意：高功耗显卡的峰值功耗基本比最大功耗多50%+（A 卡的直接翻倍估算），但是这种毫秒级别波动只有用示波器能看到，而厂家却从来不负责功耗超标问题。所以，用 80/90 系显卡务必搭配不虚标的大功率电源，有个说法至少要一瓦一块钱判断电源是否靠谱
