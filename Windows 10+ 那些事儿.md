...
如果感觉你的游戏中画质有点糊，不够清晰锐利，即使在游戏设置中把贴图细节拉到最高也没有效果，尤其是TAA抗锯齿会糊的略重一点。在游戏设置里找显示画面的设置页，把“锐化”相关选项拉高再看看，如果启用了 DLSS（深度学习抗锯齿），可能还有 DLSS 的锐化选项。另外，DLSS 的档位尽量选择“质量”或“DLAA”，比“性能”档更清晰。还可以试试渲染倍率到100%，是不是解决了糊的问题。
...
4、显示器从 1080P 换成 4K，画质也能有明显提升。
    ...
    有些游戏 2k 分辨率拉满设置里的抗锯齿选项如 dlaa，实际画面还不如 4k DLSS 的性能档。 这种情况下使用 4K 显示器非常适合开 DLSS 性能档，不影响画面体验帧数还高。
...
路径追踪
    ...
    现实游戏届的宣传受显卡厂商影响，N 卡 2080ti 时代宣传的实时光追，其实整个画面还是使用光栅化渲染的，只有反射、环境光这些使用光追来实现。而 4080 时代宣传的路径追踪，就是完全抛弃光栅化渲染，完全使用光追的路径追踪算法来形成画面。
