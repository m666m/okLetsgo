...
4k 时代 x265 等压缩算法变了，低码率视频的观感也变了：

    虚假的、难看的强烈颗粒感：

        电影（尤其是胶片拍摄或后期添加的）颗粒感，是一种高频、随机、低对比度的精细纹理。它在视觉上增加了质感、电影感和动态范围。从信号角度讲，它是遍布全图的、不规则的、像素级的微小噪声。
...
简单判断视频质量是否及格，以时长90分钟的枪战片电影为例：
    ...
    1080p 视频，码率平均 2MB/s，文件大小 h264 小于 2.1GB，h265 小于 2GB，会明显影响观感。

    2160p 4k 视频，码率平均 8MB/s, 文件大小 h265 小于 8GB，会明显影响观感，那种 5,6GB 的 4k 电影不要下载。

    美剧例外：全片的风格就是屏幕元素少，大量浅景深画面，头发都是模糊的，以上最低标准下的观感影响不明显，但是不要讲清晰度。
