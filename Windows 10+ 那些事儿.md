...
总体来说，现在的光线追踪游戏，有点类似数码相机刚开始发展的时代，清晰度是不如传统相机的，但是在多次迭代后清晰度达标了，几年功夫就实现了对传统相机的替代。Nvidia 在显卡计算能力不足时强推光线追踪，导致了至 2025 年光线追踪游戏的画面效果甚至大幅倒退不如 10 年前的游戏：
    ...
    比如 Doom:The Dark Ages，抛弃了光栅化渲染而完全使用光线追踪，为了减少反射的计算量，场景中绝大部分物体的材质都限制在粗糙度阈值之下，远景清楚贴近看都是糊，镜面效果只见于水面和地面的水洼，很少放置玻璃和镜子，反射远景的物体很少，动态光源的使用也非常克制。各种降低视觉效果，跟 DOOM2016/DOOM  ETERNAL比换来的居然只是画面整体的光影真实感更强一些，功耗近 400 瓦的 RTX5080 显卡开路径追踪后都跑不到 60 帧/秒。<https://doomwiki.org/wiki/Tiago_Sousa>
