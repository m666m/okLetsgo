...
我玩射击游戏，关垂直同步才不头晕
    ...
    除非遇到画面撕裂的问题，再开垂直同步。这个技术锁帧为你的屏幕刷新率数值解决画面撕裂，但是会导致画面延迟，如果开启三重缓冲能缓解头晕，但是画面延迟更严重偶尔会卡一下。

    酌情处理吧，如果快速晃动鼠标画面没有迟滞就开三重缓冲。

    头晕的原因可能在于相对于手的动作，屏幕的显示有延迟且随帧率波动，fps 射击游戏频繁快速的转身和视角变换导致大脑对手运动的感知和对视觉的感知不一致，进而导致头晕。

    另外把环境晃动、摄像头晃动都关了，这种老式游戏靠看不清甚至头晕恶心来制造压抑感，然后胜利给你释放的快感。没啥意思，关了不影响游戏性。
