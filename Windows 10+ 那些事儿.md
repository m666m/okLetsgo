...
如果感觉你的游戏画面有点糊，不够清晰锐利，即使在游戏设置中把贴图细节等选项拉到最高还是糊，尝试以下方法。
...
很多游戏都使用自动曝光技术，根据视野焦点把暗部慢慢给你调亮，导致被光线直射的物体背光的暗部出现死黑，只看暗部又会受环境光照影响慢慢变亮，让你的眼睛非常不舒服。这不是什么黑屋看门口强光的 HDR 过曝效果，这就是游戏对光线直射和背光混杂的视角变化处理的不好，完全属于游戏的设计和调校问题：

    比如 赛博朋克2077 的白天场景各种物体的背光面死黑，屋里也死黑，在阳光直射的大街上转动视角就有想打手电筒的感觉，原地蹲下屏幕四边都发黑就像犯了低血糖。。。为什么 2077 玩家都喜欢秀夜景？因为夜景不介意暗处黑，站个大灯底下看彩灯实在太酷炫。像 2077 这样粗暴的光污染却契合了赛博朋克风格，属于取巧了。
...
游戏内的设置，开启 “路径追踪”，可以稍微增强画面整体的亮度和明暗表现，真实感更强。开启了光线的多次反弹，让物体反光后也会投射光线到其他物体，这样有粗糙度材质物体反光也会使周围环境稍微变亮。增加了光的二次反弹后，火焰、灯条等自发光材质也能稍微照亮周边物体。
