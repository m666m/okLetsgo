...
设置：打开Windows安全中心
    ...
    目前发现windows 10 21H1版本的“核心隔离”类别中缺少“内核DMA 保护”、“固件保护”等，而windows 2019 LTSC版本是有的，如果想显示“你的设备超出增强的硬件安全性要求”，需要在下面的页面慢慢研究如何开启。
    ...
    更多关于Windows10安全性要求的选项参见下面这个页面的各个子目录章节
...
最优选
    ...
    设置->个性化->颜色：下面有个“更多选项”，对“选择默认应用模式”选择“暗”，整个Windows的配色方案都变成了暗色，各个软件窗口也跟着变了。
    这个办法最舒服，白天切换回去也很方便。写到注册表里，在桌面点击右键实现方便切换，Add_App_Mode_to_desktop_context_menu.reg：
