...
但是，如果 3D 游戏画面显示技术想再进一步，实现动态效果的照片级真实感，比如像过场动画一样的游戏效果，光栅化处理技术就有很大的限制：
    ...
    比如光源无法变化导致场景也不能被破坏和移动，可交互性很差。自由运动的游戏人物和角色，在光线变化时很难跟场景中光线的色调协调，比如你会看到游戏角色跑进黑洞但仍然发白的现象。光栅化也无法实现汽车表面这种曲面的反射和镜面对照。如果使用预烘培全局光照实现动态全局光照，对规模越来越大的开放世界场景的 RPG 游戏来说，不止是开发时工作量超大，而且生成的光照信息，可能高达几十TB甚至更多，这已经无法部署到玩家硬盘了。
