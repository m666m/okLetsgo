...
有些实景少的低质量电影，全用浅景深给人物特写。虽然你觉得背景模糊很自然，但是整个电影看下来的感觉就是像看美剧 --- 只有人脸清楚，出门就糊，整个片子的视觉印象就是糊里巴涂。这个问题的根子在 CGI 的模糊技术上：
...
如果制作时优先考虑观众视觉感受，CGI 背景可以给你大景深的清晰宏大视野，画面细节逼真元素丰富，运动镜头也能保证不是全糊适当看清，最有代表性的就是《阿凡达》、《哪吒》系列。

但很多电影走向了反面，用 CGI 背景偷工减料，最典型的是《蚁人：量子狂潮》：科幻电影可以不要真实感，但是背景全糊连各种炫光都糊，只有明显割裂出来的前景有两个演员在大喊大叫，画面感类似奥特曼真人动画。作为商业大片，只要宣发给力让人热闹一阵就够本了，但片子是真坑人。而且这部电影的制作成本居然达到 3.8亿 美元，超过阿凡达2，里面有多少内幕不可想象。
