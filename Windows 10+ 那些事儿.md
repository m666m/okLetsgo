...
要根据连接的显示设备进行调整。一般来说，显示器或者电视机会有 “HDMI黑色水平” 这样的设置选项，其实就是两种不同的明度色阶（16-235）和（0-255）：
...
另外如果你的显示器/电视机连接PS4、Xbox，同样要注意RGB输出动态范围与显示设备的匹配。
...
很多游戏都使用自动曝光技术，根据视野焦点把暗部慢慢给你调亮，导致被光线直射的物体暗部出现死黑，只看暗部又会慢慢变亮，让你的眼睛非常不舒服。这不是什么黑屋出门看强光的 HDR 过曝效果，这就是游戏对光线直射和背光混杂的视角变化处理的不好，完全属于游戏的设计和调校问题：
    ...
    比如 赛博朋克2077 的白天场景各种物体的暗部动态死黑，在阳光直射的大街上转动视角就有想打手电筒的感觉，原地蹲下屏幕四边都发黑就像犯了低血糖。。。为什么 2077 玩家都喜欢秀夜景？因为夜景不介意暗处黑，站个大灯底下看彩灯实在太酷炫。像 2077 这样粗暴的光污染却契合了赛博朋克风格，属于取巧了。
...
这种在开放式场景内暗部死黑的游戏很常见，根源在于光线追踪迫于计算量优化不能放置太多光线，这就非常依赖美工对材质风格的统一处理和具体场景设计时的光影调校，大多数厂商不是实力不足就是不想花太多时间进行调校。
