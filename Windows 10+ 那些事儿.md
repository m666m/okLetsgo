...
鼠标对准屏幕中心的某个物体，横向平移跑动，或纵向前后跑动，保持对准该物体。如果画面中央出现轻微的水波纹或撕裂感，就说明需要开垂直同步，把游戏的帧率锁定为显示器的刷新率，但会导致头晕。

我玩射击游戏，关垂直同步才不头晕

    建议除非遇到画面撕裂或抖动的问题，再开垂直同步，也可选择开启三重缓冲缓解头晕，但是偶尔会卡一下。酌情处理吧，一般来说开三重缓冲后，快速晃动鼠标时画面里的动作跟随没有迟滞感就可以。
