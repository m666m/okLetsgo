...
2020 年代之前的游戏
    ...
    都是光栅化技术来渲染画面，可以实现光线的反射折射阴影。依靠游戏开发时在场景中预烘培实现全局光照，这样已经可以给玩家照片级的真实感了，贴图细节调高就可以看到非常清晰的画面，场景中光线充足各处都不会太黑。比如 2007年的 《孤岛危机》、2016年的《神秘海域四》、2020年的《美国末日2》、2018年的《荒野大镖客2》，场景美轮美奂。

    在游戏设置中贴图细节选择越高、LOD 拉的越高，画面就越清晰。

但是，3D 游戏画面显示技术想再进一步，实现动态效果的照片级真实感，比如像过场动画一样的游戏效果，光栅化处理却做不到：比如光源无法变化，阳光射入的室内通过预烘培的光照能给你照片级真实感，但是太阳不能移动，场景也不能被破坏和移动，可交互性很差。自由运动的游戏人物和角色，在光线变化时很难跟场景中光线的色调协调。光栅化也无法实现汽车表面这种曲面的反射和镜面对照。另外，对规模越来越大的开放世界场景的 RPG 游戏来说，预烘培生成的光照信息，最多可以高达几十TB，这已经无法部署到玩家硬盘了。
...
游戏内的设置，开启 “路径追踪”，可以稍微增加画面整体的亮度，清晰感更强。这是利用的光线的多次反射，即使物体是有粗糙度的材质也会稍微变亮。另外，火焰、灯光等自发光材质也能稍微照亮周边，这些都可以增加一点场景中物体的暗部亮度。
