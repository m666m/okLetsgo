...
Nvidia 在显卡计算能力不足时强推光线追踪，导致了到 2025 年光线追踪游戏的画面效果还不如 10 年前的游戏：
    ...
    比如，优化最好的，死黑基本看不到的，Doom:The Dark Ages。号称完全使用光线追踪（其实是部分烘焙再加强制硬件光追，光影效果很细腻），计算量超级大：为了减少反射的计算量，场景中绝大部分物体的材质都限制在粗糙度阈值之下，远景清楚贴近看都是糊，镜面效果只见于部分水面和地面的水洼，很少放置玻璃和镜子，反射远景的物体很少，动态光源的使用也非常克制。相比 DOOM2016/DOOM ETERNAL 各种减少视觉元素，居然只是画面整体的光影真实感更强一些，功耗近 400 瓦的 RTX5080 显卡开路径追踪后都跑不到 60 帧/秒。<https://doomwiki.org/wiki/Tiago_Sousa>
...
游戏内的设置，开启 “路径追踪”，可以稍微增强画面整体的亮度和明暗表现，真实感更强。这是利用的光线的多次反射，物体反光后也会投射光线到其他物体，反光物体即使是有粗糙度的材质也会使周围环境稍微变亮。另外，火焰、灯条等自发光材质也能稍微照亮周边，这些在增加了光的二次反弹后都可以增加周边物体的亮度。判断是否使用了路径追踪，背向直射光源看反光点，其反射光线到其他物体，这些物体是否改变了亮度和颜色。
