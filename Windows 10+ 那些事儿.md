...
从 2007 年代英特尔就尝试用多核心通用图形处理器（GPGPU）代号 Larrabee 来实现光追游戏 <https://www.gameres.com/853845.html>，甚至云游戏串流运行。但直到 2018 年 Nvidia RTX 2080 显卡引入了 RT core 进行硬件加速才真正成为了现实（光追游戏体验见 赛博朋克2077）。如果计算光线的二次反射即所谓路径追踪，漫反射下的光影真实感更强，但帧数再爆降 30%+。
...
4、使用 4K 分辨率，依靠使用高分辨率材质来提高清晰度（如果游戏在开发时没有对材质进行粗糙化处理的话）。
...
没有 4k 显示器，可以尝试开启 Nvidia DLDSR(深度学习动态超分辨率) 让你的 1080P 显示器秒变 4K：
    ...
    开启方法
        ...
        Doom:The Dark Ages 等原生支持在游戏内选择4K分辨率，不需要在显卡驱动设置中开启 DLDSR。
