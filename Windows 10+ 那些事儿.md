...
我玩射击游戏，关垂直同步才不头晕
    ...
    除非遇到画面撕裂或抖动的问题，再开垂直同步。这个技术锁帧为你的屏幕刷新率数值来解决问题，但是会导致画面稍微延迟，导致头晕。选择开启三重缓冲能缓解头晕，但是偶尔会卡一下。酌情处理吧，一般来说开三重缓冲，快速晃动鼠标画面跟随晃动没有迟滞感就可以了。

        鼠标保持对准屏幕中心的某个物体，横向跑动平移，或纵向前后跑动，如果画面中央出现轻微的水波纹或撕裂感，就说明需要开垂直同步。
