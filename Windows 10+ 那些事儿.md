...
光线追踪的效果对有光和无光混杂的视角变化处理不好，亮处很亮而暗部画面非常暗，除非转头只看暗处才能看清，在支持 HDR 效果的游戏上特别明显。这个问题的根源在于游戏的调校，调校不好的例子是2077的白天出入建筑,调校的好的例子是 Doom:The dark ages，明暗过渡更自然，高光给人冲击暗部又足够的亮度，细节丰富，没有 2077 那种门口的箱子死黑看不清只能趴下看，大白天想打手电筒的情况。
