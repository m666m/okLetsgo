...
目标系统类型 UEFI/CSM
    ...
    在windows 10/11安装之前，如果要享受快速启动进入Windows，则需要在主板的BIOS设置中明确开启UEFI选项，目前的很多主板BIOS设置中，启动模式选项要选择“windows 10”而不是“other os”，CMS模式选择“关闭”即可。这里要注意，CMS模式开启时，关于存储和pcie设备的选项要保证是UEFI模式。详见下面章节 [技嘉主板BIOS设置 UEFI + GPT 模式启动windows]
